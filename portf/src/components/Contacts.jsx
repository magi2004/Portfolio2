  ...
  return (
    <div className='bg-gradient-to-br from-blue-700 via-gray-800 to-gray-700 text-white py-16' id='contacts'>
        <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            <h2 className='text-4xl font-bold text-center mb-12 bg-gradient-to-br from-blue-700 text via-gray-800 to-gray-700 text-orange-400 rounded-full py-3'>Contact Me</h2>
            <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                ...
                <div className='mb-4 mt-4' >
                    ...
                    <a href='mailto:magibalan55@gmail.com' className='hover:text-purple-300'>
                        magibalan55@gmail.com
                    </a>
                </div>
                <div className='mb-4'>
                    <FaPhone className='inline-block text-yellow-400 mr-2 '></FaPhone>
                    <span className='hover:text-purple-300'>+919442587723</span>
                </div>
                <div className='mb-4'>
                    <FaMapMarkedAlt className='inline-block text-yellow-400 mr-2'></FaMapMarkedAlt>
                    <span className='hover:text-purple-300'>Tiruppur, India</span>
                </div>
                </div>

        ...
        <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            ...
            <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                ...
                <div className='flex-1 w-full'>
                    <form className='bg-gradient-to-tr from-blue-700 to-cyan-500 p-8 rounded-xl'>
                        ...
                        <div className='flex flex-col space-y-4'>
                            ...
                            <button className='bg-gradient-to-r from-blue-700 to-cyan-500 rounded-3xl border px-6 py-2 hidden md:inline transform transition-transform duration-200 hover:scale-110'>Send</button>
                        </div>
                    </form>
                </div>
            </div>

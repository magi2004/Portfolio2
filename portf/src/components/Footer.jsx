    ...
    <footer className='bg-gradient-to-br from-blue-400 to-cyan-500 text-white py-8'>
        <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            ...
            <form>
                ...
                <button className='bg-gradient-to-r from-blue-700 to-cyan-500 rounded-3xl border px-4 py-2 md:inline transform transition-transform duration-200 hover:scale-110'>Subscribe</button>
            </form>
            </div>
        </div>
        <div className='border-t-4 border-gray-800 pt-4 flex flex-col md:flex-row justify-between items-center text-center md:text-left space-y-3 md:space-y-0 lg:space-y-0'>
            ...
            <div className='flex space-x-4 '>
                <a href='#' className='hover:text-black hover:scale-125 transform transition-transform duration-200 text-2xl'>
                    <FaLinkedin/>
                </a>
                <a href='#' className='hover:text-black hover:scale-125 transform transition-transform duration-200 text-2xl'>
                    <FaInstagram/>
            ...
            <div className='flex space-x-4 text-xl'>
                <a href='#' className='hover:text-black hover:scale-110 transform transition-transform duration-200'>
                    Privacy
                </a>
                <a href='#' className='hover:text-black hover:scale-110 transform transition-transform duration-200'>
                    Terms of Service
